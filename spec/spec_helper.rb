...
RSpec.configure do |config|
  ...
  config.before(:each) do
    #stub_request(:any, "https://api.open.fec.gov/")
    #response_file = File.new("spec/support/candidates_all.json")
    #stub_request(:any, "https://api.open.fec.gov/v1/candidates/?api_key=API_KEY").to_return(response_file.read)
    #stub_request(:any, "https://api.open.fec.gov/v1/").to_return(@responses[request.uri.to_s])
